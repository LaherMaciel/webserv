# All source files
SRCS_CPP = main.cpp Connection.cpp Server.cpp RequestParser.cpp utils.cpp Request.cpp Response.cpp
SRCS_DIRECTORY = src/
SRCS_LIST = $(addprefix $(SRCS_DIRECTORY), $(SRCS_CPP))

# Header files
HEADER_LIST = webserv.hpp Connection.hpp RequestParser.hpp Request.hpp Response.hpp
